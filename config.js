...
//═══════[Required Variables]════════\\
global.owner = process.env.OWNER_NUMBER ? process.env.OWNER_NUMBER.replace(/[\s+]/g, '') : '94715485468';
...
global.timezone  = process.env.TIME_ZONE || 'Asia/Nuwaraelia'
...
global.website = 'https://github.com/vajirabot1/KING-VAJIRA-MD' ; //wa.me/+94715485468
global.THUMB_IMAGE = process.env.THUMB_IMAGE || 'https://drive.google.com/file/d/1Dcl691m1D95LV7gyQ4NxElou8-w1oJaE/view?usp=drivesdk' ;
module.exports = {
  sessionName: process.env.SESSION_ID || "VAJIRA;;;NotifyDistant
",      //Put Your Session Id Here
  botname: process.env.BOT_NAME || 'QUEEN KAVEE',
  botbgm: process.env.BOT_BGM || 'false',
  ownername:  process.env.OWNER_NAME || `It'x Kalum S.Viduranga`,
